      ...
      <div className="NewsListTopItem">
        ...
        <div className="NewsListTopItem__content">
          ...
          <div className="NewsListTopItem__summary">
            ...
            sérstaklega mikilvæg nú á tímum samkomu- banns og aflýstra viðburða. Náttúran
            er enn opin og á útivistar- svæðum er auðvelt að hlýða Víði og virða tveggja
            metra regluna en á sama tíma finna fyrir ákveðinni nálægð við annað fólk.
          </div>
