...
o.spec('cssVars', () => {
  o('exposes known CSS variable tokens', () => {
    const expectedTokens: Record<HannaCssVarToken, true> = {
      ...
      font_heading_xl_size: true,
      font_heading_xl_leading: true,
      font_heading_l_size: true,
      font_heading_l_leading: true,
      font_heading_m_size: true,
      font_heading_m_leading: true,
      font_heading_s_size: true,
      font_heading_s_leading: true,
      font_heading_xs_size: true,
      font_heading_xs_leading: true,
      font_body_l_size: true,
      font_body_l_leading: true,
      font_body_m_size: true,
      font_body_m_leading: true,
      font_body_s_size: true,
      ...
      font_base: true,
      font_heading_xl: true,
      font_heading_l: true,
      font_heading_m: true,
      font_heading_s: true,
      font_heading_xs: true,
      font_body_l: true,
      font_body_m: true,
      font_body_s: true,
      font_button: true,
      ...
      /**/ icon__chek__do_not_use: true, // inserted to avoid a clash with Material Symbols font
